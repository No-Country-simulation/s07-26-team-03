...
export default function CalculatorSidebarContent() {
    return (
        <>
            <div>
                <h2 className="font-heading text-[32px] font-semibold leading-[110%] text-heading dark:text-white">
            ...
            <ul className="mt-[45px] flex flex-col gap-8 mb-6">
                <li className="flex items-start gap-4">
                    <div className="flex h-[40px] w-[40px] shrink-0 items-center justify-center rounded-full bg-[#E7F0EB] dark:bg-[#252525] text-brand-primary shadow-[inset_0px_-1.17px_1.17px_rgba(14,106,55,0.25)]">
                        <LuClock className="h-5 w-5 dark:bg-[#252525] dark:text-white" />
                    </div>
                    <div>
                ...
                <li className="flex items-start gap-4">
                    <div className="flex h-[40px] w-[40px] shrink-0 items-center justify-center rounded-full bg-[#E7F0EB] dark:bg-[#252525] text-brand-primary shadow-[inset_0px_-1.17px_1.17px_rgba(14,106,55,0.25)]">
                        <LuLockKeyholeOpen className="h-5 w-5 dark:bg-[#252525] dark:text-white" />
                    </div>
                    <div>
                        <h3 className="font-heading text-base font-medium leading-[110%] text-text dark:text-gray-300">
                            No sign-up required
                ...
                <li className="flex items-start gap-4">
                    <div className="flex h-[40px] w-[40px] shrink-0 items-center justify-center rounded-full bg-[#E7F0EB] dark:bg-[#252525] text-brand-primary shadow-[inset_0px_-1.17px_1.17px_rgba(14,106,55,0.25)]">
                        <LuChartColumn className="h-5 w-5 dark:bg-[#252525] dark:text-white" />
                    </div>
                    <div>
                        <h3 className="font-heading text-base font-medium leading-[110%] text-text dark:text-gray-300">
                            Actionable Insights
